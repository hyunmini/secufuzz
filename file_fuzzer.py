# -*- coding: utf-8 -*-
'''
	## File Format Dumb Fuzzer v0.2 - by hyunmini ##
...
class File_Fuzzer:
	...
	def File_Picker(self):
		print self.sample_path + "*." + self.sample_ext
	...
	def Report(self):
		print u"  [*] 레포트 생성 및 전송 중입니다."
		title = "Hyunmini's Fuzzer Report - " + datetime.now().strftime("%Y%m%d_%H%M%S")
		...
		send_gmail('gmail id', 'gmail password', 'mail@address', title, body)
